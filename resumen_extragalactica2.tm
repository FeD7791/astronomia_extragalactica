...
<\body>
  ...
  <\itemize-minus>
    ...
    <item>Otro sistema comunmene utilizado es el sistema AB. Hablemos ahora
    del sistema AB y el sistema Vega. Deacuerdo a la definicion de magnitud:\ 

    <\equation*>
      m<rsub|1>-m<rsub|2>=-2.5 log<around*|(|<frac|f<rsub|1>|f<rsub|2>>|)>=-2.5<around*|[|log<around*|(|f<rsub|1>|)>-log<around*|(|f<rsub|2>|)>|]>
    </equation*>

    <item>Nos interesaria saber el punto cero de la escala de magnitudes.
    Este punto cero tendria en concreto:

    <\equation*>
      m<rsub|zp>=0
    </equation*>

    <item>Entonces esto nos permitiria escribir:

    <\equation*>
      m-m<rsub|zp>=-2.5 log<around*|(|f|)>+2.5log<around*|(|f<rsub|zp>|)>
    </equation*>

    <item>La idea es que en cada uno de los filtros se estableciera
    <math|m<rsub|zp>=0> para vega.\ 

    <item>Mediciones mas precisas de las magnitudes provocaron
    inconsistencias e hicieron que la magnitud asociada a Vega ya no fuera
    cero si no que la misma aumentara ligeramente a 0.035.

    <image|file:///home/fede/Pictures/Screenshots/Screenshot from 2025-01-30
    17-38-32.png|0.7par|||>

    Por otro lado si miramos la imagen del flujo de vega , vemos que para
    frecuencias altas el flujo de vega varia muchisimo y ademas es muy chico

    <item>Para evitar todos estos problemas se introduce el sistema AB. Este
    sistema el espectro de referencia es un espectro plano:
    <math|f<rsub|\<nu\>>=const>. Notese que no estamos diciendo que
    <math|m<rsub|AB>=0>. Solamente en la banda <math|V>:
    <math|m<rsub|V><rsup|Vega>=m<rsub|V><rsup|AB>=0>

    \;
  </itemize-minus>

  <\itemize-dot>
    <item>Magnitud Absoluta: <math|m<rsub|X>-M<rsub|X>=5
    log<around*|(|<frac|D|1 pc>|)>-5 \<mu\>>
  </itemize-dot>
  ...
  <subsubsection|Galaxias Elipticas>

  Las galaxias elipticas cubren una basta cantidad de objetos con diferentes
  luminosidades y tamanios. Una clasificacion de las mismas puede darse como:

  <\itemize-minus>
    <item>Elipticas Normales: Incuye las gigantes elipticas , luminosidad
    intermedia, y elipticas compactas. Estas cubren un rango de magnitudes
    absolutas de <math|<around*|[|-23,-15|]>>

    <item>Elipticas Enanas:
  </itemize-minus>
...
<\references>
  <\collection>
    ...
    <associate|auto-17|<tuple|6.2.2|13>>
    <associate|auto-18|<tuple|2|13>>
    <associate|auto-19|<tuple|6.2.3|14>>
    <associate|auto-2|<tuple|1.1|1>>
    <associate|auto-20|<tuple|6.2.4|15>>
    <associate|auto-21|<tuple|6.2.5|15>>
    <associate|auto-22|<tuple|7|15>>
    <associate|auto-23|<tuple|8|15>>
    <associate|auto-24|<tuple|9|15>>
    <associate|auto-25|<tuple|10|15>>
    <associate|auto-26|<tuple|11|15>>
    <associate|auto-27|<tuple|12|15>>
    <associate|auto-28|<tuple|13|15>>
    <associate|auto-29|<tuple|14|15>>
    <associate|auto-3|<tuple|1.2|1>>
    <associate|auto-30|<tuple|15|15>>
    <associate|auto-31|<tuple|15.1|20>>
    <associate|auto-32|<tuple|15.2|20>>
    <associate|auto-33|<tuple|15.2.1|21>>
    <associate|auto-34|<tuple|3|22>>
    <associate|auto-35|<tuple|15.2.2|22>>
    <associate|auto-36|<tuple|15.2.3|22>>
    <associate|auto-37|<tuple|15.2.4|23>>
    <associate|auto-38|<tuple|15.2.5|23>>
    <associate|auto-39|<tuple|15.2.6|24>>
    <associate|auto-4|<tuple|2|1>>
    <associate|auto-40|<tuple|15.2.7|24>>
    <associate|auto-41|<tuple|4|25>>
    <associate|auto-42|<tuple|5|26>>
    <associate|auto-43|<tuple|6|26>>
    <associate|auto-44|<tuple|7|27>>
    <associate|auto-45|<tuple|8|28>>
    <associate|auto-46|<tuple|9|29>>
    <associate|auto-47|<tuple|15.2.8|29>>
    <associate|auto-48|<tuple|15.2.9|29>>
    <associate|auto-49|<tuple|15.2.10|30>>
    <associate|auto-5|<tuple|2.0.1|1>>
    <associate|auto-50|<tuple|16|?>>
    <associate|auto-6|<tuple|1|1>>
    <associate|auto-7|<tuple|2.0.2|3>>
    <associate|auto-8|<tuple|2.0.3|4>>
...
<\auxiliary>
  <\collection>
    ...
    <\associate|toc>
      ...
      <with|par-left|<quote|2tab>|2.0.2<space|2spc>Escala de Magnitudes
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-7>>

      <with|par-left|<quote|2tab>|2.0.3<space|2spc>Estrellas
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      ...
      <with|par-left|<quote|2tab>|6.2.4<space|2spc>Distribucion Bimodal de
      Colores de las Galaxias. <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
